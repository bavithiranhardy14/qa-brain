...
> **This is the active working story.**
> Copy a story from `stories/US-NNN_name.md` here before running the skills.
> Update `stories/story_index.md` to set that story's status to 🔄 In Progress.
...
📄 [View Execution Summary](stories/outputs/US-003_execution_summary.md)
...
📄 [View Risk Analysis](stories/outputs/US-003_risk_analysis.md)
...
📄 [View Test Cases](stories/outputs/US-003_test_cases.md)
